  ...
  return (
    ...
    <View style={styles.container}>
      <View style={styles.container}>
        ...
        <Text style={tw`text-2xl font-bold text-blue-700`}>KPK Hydropower renewable energy</Text>
        <Text style={tw`text-2xl font-bold text-blue-700`}>(Development Project)</Text>
      </View>
      <Footer />
    </View>
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName='SplashScreen' >
        ...
        <Stack.Screen name="RFIAdminDash" component={RFIAdminDash} options={{ headerShown: false }} />
        <Stack.Screen name="SiteDiaryEntry" component={SiteDiaryEntry} options={{ headerShown: false }} />
