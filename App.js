...
import RFIAdminDash from "./Screens/RFIAdminDash";
import SiteDiaryEntry from "./Screens/SiteDiaryEntry";
...
function SplashScreen({ navigation }) {
  const manageData = async () => {
    try {
      ...
      var admin_rfi = await AsyncStorage.getItem("admin_rfi");
      var site_diary_access = await AsyncStorage.getItem("site_diary_access");
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="SplashScreen">
        ...
        />
        <Stack.Screen
          name="RFIcontractorDash"
          component={RFIcontractorDash}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="RFICreDash"
          component={RFICreDash}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="RFISuperDash"
          component={RFISuperDash}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="RFIList"
        ...
        />
        <Stack.Screen
          name="RfiVerification"
          component={RfiVerification}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="EshsGCDashboard"
          component={EshsGCDashboard}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="ESHSObservationForm"
          component={ESHSObservationForm}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="ESHSGCObserveList"
          component={ESHSGCObserveList}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="ESHSDetails"
          component={ESHSDetails}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="ESHSGCFeedback"
          component={ESHSGCFeedback}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="EshsContractorDash"
          component={EshsContractorDash}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="ESHSContractorFeedback"
          component={ESHSContractorFeedback}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="IncidentList"
        ...
        <Stack.Screen
          ...
          component={IncedentDetails}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="IncedentPersonForm"
          component={IncedentPersonForm}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="IncedentPersonList"
          component={IncedentPersonList}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="IncedentPersonDetails"
          component={IncedentPersonDetails}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="NcrForm"
        ...
        <Stack.Screen
          name="NcrDetails"
          component={NcrDetails}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="NcnConReply"
          component={NcnConReply}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="NcrClose"
        ...
        <Stack.Screen
          name="RFIAdminDash"
          component={RFIAdminDash}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="SiteDiaryEntry"
          component={SiteDiaryEntry}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="DashBoard"
