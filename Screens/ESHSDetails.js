...
export default function ESHSDetails({ route }) {
  ...
  const [conreply, setConreply] = useState('0')
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([dataData, dataDatadoc, dataDataCon]) => {
        ...
        setConreply(dataDataCon[0].contractor_reply)
        console.log(conreply);
      })
            ...
            renderItem={({ item }) => (
              ...
              >
                ...
                item.eshs_approved_status == '0' ? (
                 ...
                 global.eshs_contractor == '1' &&
                item.con_reply_given == '1' &&
                item.eshs_approved_status == '2' ? (
                  <View>
                    <TouchableOpacity
                      onPress={() =>
                        navigation.navigate('ESHSContractorFeedback', {
                          eshs_obs_id: conreplyID,
                          contractor_reply:conreply,
                        })
                      }
                      style={{
                        flex: 1,
