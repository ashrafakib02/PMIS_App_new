...
export default function ESHSContractorFeedback({ route }) {
    ...
    const {contractor_reply}=route.params;
    ...
    var eshs_con_form = '0';
    var eshs_con_form_fileUpload = '0';

if(contractor_reply ==''){
   eshs_con_form = global.eshs_con_form;
   eshs_con_form_fileUpload = global.eshs_con_form_fileUpload;
}else{
   eshs_con_form = global.eshs_con_form_update;
   eshs_con_form_fileUpload = global.eshs_con_form_fileUpdate;
}
