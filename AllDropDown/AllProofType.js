...
const AllProofType = (props) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={[tw` mt-2.5 ml-2.5 text-indigo-700`, styles.titleBox]}>ID Proof Type</Text>
            ...
            <Dropdown
                ...
                labelField="label"
                valueField="value"
                placeholder={!isFocus ? 'Select ID Proof' : '...'}
