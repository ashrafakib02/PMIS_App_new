...
const data = [
    ...
    { label: 'Whenever get time', value: '3' },
    { label: 'occasionally', value: '4' },
    
];
const AllParkUse = (props) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={[tw` mt-2.5 ml-2.5 text-indigo-700`, styles.titleBox]}>How often do you use this park/Open space?</Text>
