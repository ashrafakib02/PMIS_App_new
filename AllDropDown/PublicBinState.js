...
const data = [
    { label: 'Rusting/ rotting', value: '1' },
    { label: 'Adequate size', value: '2' },
    { label: 'Inadequate', value: '3' },
    { label: 'In a good state', value: '4' },
    { label: 'Not in a good condition', value: '5' },
    { label: 'Don\u0027t know', value: '6' }

];
const PublicBinState = (props) => {
