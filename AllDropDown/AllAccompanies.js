...
const data = [
  ...
  { label: "Children in your household", value: "2" },
  { label: "Senior Citizen", value: "3" },
  { label: "Cousins", value: "4" },
  { label: "Spouse", value: "5" },
  { label: "Friends", value: "6" },
  { label: "Neighbour", value: "7" },
];
const AllAccompanies = (props) => {
    ...
    <View style={styles.container}>
      <View style={{ flex: 1, flexDirection: "row" }}>
        <Text style={[tw` mt-2.5 ml-2.5 text-indigo-700`, styles.titleBox]}>
          Who accompanies you during your visit to the park/Open space?
        </Text>
        <View
        ...
        >
          <Dropdown
            ...
            labelField="label"
            valueField="value"
            placeholder={!isFocus ? "Select Accompany" : "..."}
