...
const data = [
    { label: 'Plastic bag', value: '1' },
    { label: 'Carton', value: '2' },
    { label: 'Waste Basket', value: '3' },
    { label: 'Tin/can', value: '4' },
    { label: 'Old bucket', value: '5' },
    { label: 'Others', value: '99' },
];
const AllWasteContainer = (props) => {
...
export default AllWasteContainer
