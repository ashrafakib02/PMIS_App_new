...
const data = [
    { label: 'Paper and carton', value: '1' },
    { label: 'Tins/can', value: '2' },
    { label: 'Food waste', value: '3' },
    { label: 'Glass', value: '4' },
    { label: 'Fibre bags', value: '5' },
    { label: 'Plastics', value: '6' },
    { label: 'Others', value: '99' },
];
const AllSolidWaste = (props) => {
